        ...
        <td valign="top"  style="text-align:center;width:100%;padding:20px;"> <br /><br /><br />
            <center><div style="width:220px;height:36px;margin-top:20px;overflow:hidden;padding:2px;background-color:#555555;color:white;border-radius:8px;font-size:17px;float:right"><div style="height:22px;float:left;width:90px;margin:5px;border-radius:5px; background-color:#666666;overflow:hidden" id="neuyBalance" onclick="getBalance()">0 NEUY</div><div style="height:22px;float:left;width:90px;margin:5px;margin-left:12px;overflow:hidden;border-radius:5px;background-color:dodgerblue" onclick="connect()" id="connectButton">Connect</div><div style="float:left;width:90px;margin:5px;margin-left:8px;overflow:hidden;" id="userAddress"></div></div>
                ...
                <div style="width:170px;margin-right:10px;height:32px;margin-top:20px;padding:2px;color:white;border-radius:8px;font-size:17px;float:right">
                    <div  class="dropdown">
                        <button onclick="showFromDropDown()" class="dropbtn" id="fromTokenLabel" >Ethereum ▼</button>
                        <div id="fromDropdown" class="dropdown-content">
                            <a href="../../ethereum/APY10/index.aspx" ><img src="https://dynamic-assets.coinbase.com/dbb4b4983bde81309ddab83eb598358eb44375b930b94687ebe38bc22e52c3b2125258ffb8477a5ef22e33d6bd72e32a506c391caa13af64c00e46613c3e5806/asset_icons/4113b082d21cc5fab17fc8f2d19fb996165bcce635e6900f7fc2d57c4ef33ae9.png" width="30" style="float:left;padding-left:10px;" />Ethereum</a>
                            <a href="../../polygon/APY10/index.aspx" "><img src="https://assets.coingecko.com/coins/images/4713/large/matic-token-icon.png?1624446912" width="30" style="float:left;padding-left:10px;" />Polygon</a>
                        </div>
                    </div>
                </div>
                <br /><br />
                <div style="padding-top:60px">
                    <div style="text-align:left;width:700px;background-color:#EEEEEE;height:160px;border-radius:16px;padding:20px;">
                        <div style="font-size:24px;">NEUY Staking Pool</div><br />
                        <div style="font-size:16px;">Stake your NEUY tokens to get even more NEUY tokens.</div><br />
                        <div style="font-size:14px;">A percentage of founding tokens are used to fund pool rewards. For more information, visit the NEUY Discord group.</div><br />
                    </div>
                </div>
                 <div style="padding-top:20px">
                    <div style="text-align:left;width:700px;background-color:#EEEEEE;height:300px;border-radius:16px;padding:20px;">
                        ...
                        <table style="width:100%;font-size:22px" cellspacing="10px">
                            <tr>
                                ...
                                <td style="font-size:14px;text-align:right">
                                    <b><span id="totalDeposited">$63332</span></b>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-size:14px">
                                ...
                                <td style="font-size:14px;text-align:right">
                                    <b><span id="capacity">9% Filled</span></b>
                                </td>
                            </tr>
                            <tr >
                                <td style="font-size:14px">
                                ...
                                <td style="font-size:14px;text-align:right">
                                    <b><span id="poolRate">2146.0 NEUY/week</span></b>
                                </td>
                            </tr>
                            <tr >
                                <td style="font-size:14px">
                ...
                <div style="padding-top:20px" hidden="hidden" id="positionDiv">
                   <div style="text-align:left;width:700px;background-color:red;border-radius:16px;padding:20px;color:white" id="errorMessageDiv" hidden="hidden">
                    ...
                    <div style="margin-top:20px;text-align:left;width:700px;background-color:#EEEEEE;height:270px;border-radius:16px;padding:20px;">
                        ...
                        <table style="width:100%;font-size:22px" cellspacing="10px">
                            ...
                            <tr >
                             ...
                             <tr >
                                ...
                                <td style="font-size:16px;text-align:right">
                                    <b><span id="timelapsed">0.0 USDC</span></b>
                                </td>
                            </tr>
                        </table>
                        <br />
